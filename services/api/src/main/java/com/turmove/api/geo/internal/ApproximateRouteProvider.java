...
import com.turmove.api.geo.api.RouteEstimate;
 ...
 *
 * <p>Anahtar geldiğinde {@code turmove.maps.api-key} tanımlanır ve bu bean devre dışı
 * kalır; yerine gerçek Routes çağrısı yapan uygulama geçer (ANAHTARLAR.md #1).
 */
@Component
@ConditionalOnProperty(name = "turmove.maps.api-key", havingValue = "", matchIfMissing = true)
